                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <div class="flex-1 min-w-[80px] rounded-lg bg-gray-50 px-3 py-2 text-center dark:bg-gray-900/50">
                            <div class="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase">
                                KW {{ $row->kw }}
                            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-start mb-6 border-b border-gray-100 pb-4 dark:border-gray-700">
                        <div>
                            <div class="font-bold text-lg text-gray-900 dark:text-white">
                                {{ $first->kode_lahan }} - {{ $first->nama_lahan }}
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sumber Lahan</div>
                        </div>
                        <div class="text-ls font-black text-primary-600 dark:text-primary-400">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="space-y-2">
                            <div class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-tighter">
                                {{ $jenisKayu }}
                            </div>

                            <div class="flex flex-wrap gap-2">
                                @foreach ($rows as $row)
                                <div class="flex-1 min-w-[70px] rounded-lg bg-gray-50 px-3 py-1.5 text-center dark:bg-gray-900/50">
                                    <div class="text-[9px] text-gray-500 dark:text-gray-400">KW {{ $row->kw }}</div>
